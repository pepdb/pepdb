...
require settings.root + '/modules/comparativesearch'
require settings.root + '/modules/dbinsert'
require settings.root + '/modules/datatablesserver'
require settings.root + '/modules/motifsearch'
require settings.root + '/modules/compclustersearch'
require settings.root + '/modules/columnfinder'
require settings.root + '/modules/dbdelete'
require settings.root + '/modules/tooltips'
require settings.root + '/modules/aminoaciddist'
require 'digest/sha1'
require 'date'
require 'sass'
require 'haml'
