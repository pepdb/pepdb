  ...
  module DataTablesServer 
    ...
    class DataTablesData
      ...
      def get_result
        ...
        @columns= [:peptide_sequence, :rank, :reads, :dominance, :dataset] if @referer.include?("property-search")      
        rows = []
